...
for line1, line2, line3, line4, line5 in zip(restaurants[1:], food_kinds[1:], short_address[0:], long_address[2::2], long_address[3::2]):
    print(line1.get_text(), end= '/ ')
    print(line2.get_text(), end= '/ ')
    print(line3.get_text(), end= '/ ')
    print(line4.get_text(), end= '/ ')
    #주소 겹치는거 해결
    part_address =  line5.get_text().partition('서울')
